...
const initialNeeds = [
  {
    ...
    description:
      'I am offering my blue couch with pillows for those in need. It has been used, so there are some stains on it, but it will do for sleeping and chilling."\n',
    kind: "offer",
    estimatedQuantity: {
      value: 1,
      measurements: "couch",
  ...
  },
  {
    ...
    description:
      "Hello, I need someone that can walk my dog for me. I am 70 years old, and I have issues with walking long distances, and I would need someone that can walk my dog 3 times a day.\n",
    kind: "need",
    image: dogImg,
    estimatedQuantity: {
      value: 10,
  ...
  },
  {
    ...
    description:
      "I have been tested with the virus, and I have been tested positive for the virus. I am a single woman living at home, and I cannot go to the supermarket anymore. Could someone help me get the groceries?",
    kind: "need",
    image: groceriesImg,
    estimatedQuantity: {
      value: 10,
  ...
  },
  {
    ...
    description:
      "I am a LGBT mentor that is looking for people to support. Please reach out to me if you need help",
    kind: "need",
    image: lgbtImg,
    estimatedQuantity: {
      value: 10,
...
const initialOffer = [
  {
    ...
    description:
      "I am offering free meals to those who need it the most. Vegetarian and vegan options available, I am also able to deliver it for free to your door",
    kind: "offer",
    image: foodImg,
    estimatedQuantity: {
      value: 3,
  ...
  },
  {
    ...
    description:
      "In my garage, I found this sweet little dog plushie. I don't use it anymore, and I think I can make someone happy with it. Feel free to ping me.",
    kind: "offer",
    image: dogTollImg,
    estimatedQuantity: {
      value: 1,
  ...
  },
  {
    ...
    description:
      "My baby cannot wear these clothing anymore, so I am giving these away for free. Clothing appropriate for 1-3 year old.\n",
    kind: "offer",
    image: closesImg,
    estimatedQuantity: {
      value: 3,
